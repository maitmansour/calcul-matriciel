...
public class Matrice {
	...
	public static void showmenu(){
		...
		System.out.println("4.Récupérer l'element situe a M1[2][2]");
	...
	public static void select(){
		...
		try{
			while(yes==0){
				...
				switch(ch){
					case 0:
					m1 = new Matrice("C:\\Users\\NUMIDEA\\Desktop\\filename2.txt");
					m2 = new Matrice("C:\\Users\\NUMIDEA\\Desktop\\filename3.txt");
    ...
    //Récupérer l'element situe a M1[2][2]
					System.out.println("Récupérer l'element situe a M1[2][2]= "+m1.getElement(2, 2)); 
