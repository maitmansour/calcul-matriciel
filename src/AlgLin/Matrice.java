...
public class Matrice {
	...
	Matrice inverse() throws IllegalOperationException {
		if (getNbColonnes() != getNbLignes()) {
			...
			//Recuperation de chaque colonne de la matrice d'identité comme Vecteur
		...
		try {
			while (yes == 0) {
				...
				case 4:
					...
					// Rï¿½cupï¿½rer l'element situe a M1[2][2]
					System.out.println("Rï¿½cupï¿½rer l'element situe a M1[2][2]= " + m1.getElement(2, 2));
